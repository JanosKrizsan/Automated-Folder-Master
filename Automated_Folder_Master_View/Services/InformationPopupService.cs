...
namespace Master_View.Services
{
    public static class InformationPopupService
    {
        ...
        private const string _usageGuideSecond = "Double clicking on the directory will select it and add it to the paths monitored. Selecting the path and pressing Delete in the bottom left list, will deselect it.";
        private const string _usageGuideThird = "Double clicking on an already selected path will bring up its options window, where you can edit it's details.";
